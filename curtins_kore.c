...
/**
 * curtin_exit - exit of the program
 * @data: struct for the program's data
 * Return: zero if sucess, or other number if its declared in the arguments
 */
int curtin_exit(data_of_program *data)
{
	int i;
...
/**
 * curtin_cd - change the directory
 * @data: struct for the program's data
 * Return: zero if sucess, or other number if its declared in the arguments
 */
int curtin_cd(data_of_program *data)
{
...
/**
 * curtin_help - shows the environment where the shell runs
 * @data: struct for the program's data
 * Return: zero if sucess, or other number if its declared in the arguments
 */
int curtin_help(data_of_program *data)
{
	int i, length = 0;
...
/**
 * curtin_alias - add, remove or show aliases
 * @data: struct for the program's data
 * Return: zero if sucess, or other number if its declared in the arguments
 */
int curtin_alias(data_of_program *data)
{
	int i = 0;
